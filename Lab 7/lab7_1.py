...
class Menace:
    ...
    def instructions(self):
        ...
        print("* In this game, the computer will adapt its strategy based on previous matches.")
        print("* As you play more games, the challenge will become greater.")
        print("* You will be playing as X, while the computer takes on the role of O.")
